...
- 🍹  I have shipped one app on the AppStore called Drinko:
         ...
         Here is a quick recap of the features:
            - Learn the basic techniques in the 'Learn' tab;
            - Over 35 classic cocktails divided by category in the 'Cocktails' tab;
            - Mark your favorites so you will easily see them;
            - Switch between English and Italian, report bugs and connect with the dev, in the 'Settings' tab;
